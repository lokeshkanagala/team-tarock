const data = {
	'meetups' : [
		...
		},
		{
			...
			'presenters': [
			{
				'text': 'Second of the fifteen events on the occasion of tarak birthday',
				'headshot': 'https://s3.ap-south-1.amazonaws.com/teamtaraktrust.com/store/meetupfirst.png',
				'presentationTitle': 'Kathikaya old age home(SRESWS), Ananthapur'
			}
			]
		},
		{
			...
			'presenters': [
			{
				'text': 'Third of the fifteen events on the occasion of tarak birthday',
				'headshot': 'https://s3.ap-south-1.amazonaws.com/teamtaraktrust.com/store/meetupfirst.png',
				'presentationTitle': 'Viswa Janani balala ashramam, Thapathopu, Nellore District'
			}
			]
		},
		{
			...
			'presenters': [
			{
				'text': 'Fourth of the fifteen events on the occasion of tarak birthday',
				'headshot': 'https://s3.ap-south-1.amazonaws.com/teamtaraktrust.com/store/meetupfirst.png',
		...
		},
		{
			...
			'presenters': [
			{
				...
				'headshot': 'https://s3.ap-south-1.amazonaws.com/teamtaraktrust.com/store/headershothome.png',
		...
		},
		{
			...
			'location': {
				'name': 'Pragathi Youth Sangham, D. NO: 2-22/B, Stambhalagaruvu, Guntur.',
